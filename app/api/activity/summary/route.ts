...
export async function GET(request: Request) {
  ...
  const [{ data: likesData, error: likesError }, { data: savedData, error: savedError }, { data: commentsData, error: commentsError }, { data: matchData, error: matchError }] = await Promise.all([
